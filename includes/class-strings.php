...
class YTCT_Strings {
	...
	public static function get_string_groups() {
		return [
			'banner' => [
				'label' => __('Banner', 'yt-consent-translations-1.3.5'),
				'keys' => ['banner_text', 'banner_link', 'button_accept', 'button_reject', 'button_settings']
			],
			'modal' => [
				'label' => __('Modal', 'yt-consent-translations-1.3.5'),
				'keys' => ['modal_title', 'modal_content', 'modal_content_link']
			],
			'categories' => [
				'label' => __('Categories', 'yt-consent-translations-1.3.5'),
				'keys' => [
			...
			'buttons' => [
				'label' => __('Buttons', 'yt-consent-translations-1.3.5'),
	...
	public static function get_key_label($key) {
		$labels = [
			'banner_text' => __('Banner Text', 'yt-consent-translations-1.3.5'),
			'banner_link' => __('Privacy Policy Link', 'yt-consent-translations-1.3.5'),
			'button_accept' => __('Accept Button', 'yt-consent-translations-1.3.5'),
			'button_reject' => __('Reject Button', 'yt-consent-translations-1.3.5'),
			'button_settings' => __('Settings Button', 'yt-consent-translations-1.3.5'),
			'modal_title' => __('Modal Title', 'yt-consent-translations-1.3.5'),
			'modal_content' => __('Modal Content', 'yt-consent-translations-1.3.5'),
			'modal_content_link' => __('Modal Privacy Link', 'yt-consent-translations-1.3.5'),
			'functional_title' => __('Functional Title', 'yt-consent-translations-1.3.5'),
			'preferences_title' => __('Preferences Title', 'yt-consent-translations-1.3.5'),
			'statistics_title' => __('Statistics Title', 'yt-consent-translations-1.3.5'),
			'marketing_title' => __('Marketing Title', 'yt-consent-translations-1.3.5'),
			'functional_content' => __('Functional Description', 'yt-consent-translations-1.3.5'),
			'preferences_content' => __('Preferences Description', 'yt-consent-translations-1.3.5'),
			'statistics_content' => __('Statistics Description', 'yt-consent-translations-1.3.5'),
			'marketing_content' => __('Marketing Description', 'yt-consent-translations-1.3.5'),
			'show_services' => __('Show Services', 'yt-consent-translations-1.3.5'),
			'hide_services' => __('Hide Services', 'yt-consent-translations-1.3.5'),
			'modal_accept' => __('Accept All Button', 'yt-consent-translations-1.3.5'),
			'modal_reject' => __('Reject All Button', 'yt-consent-translations-1.3.5'),
			'modal_save' => __('Save Button', 'yt-consent-translations-1.3.5')
		];
